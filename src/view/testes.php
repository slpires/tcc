...
/*
    /src/view/testes.php
    [INCLUSÃO]
    View do módulo de Testes Automatizados.
...
<head>
  <meta charset="UTF-8">
  <title>Testes | SLPIRES.COM</title>
...
<body class="sistema-bg">
  <div class="sistema-container app">
    ...
    <div class="app-title">Testes do Sistema</div>
    <div class="app-desc" style="margin-bottom: 2.5em;">
      Você está na página do módulo <strong>Testes do Sistema</strong>.<br>
